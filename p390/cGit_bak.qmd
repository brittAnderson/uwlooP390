...
### An Old Video Overview of Git and Github
...
#### What Does Forking Mean? Some Common Git Terms
...
You will need an ssh key. And the easiest way to get an SSH key is via the terminal. If you haven't done any of the terminal exercises, now might be a good time to go there, do at least the basics so you know where your termina is, and then come back here to finish the set up. 
