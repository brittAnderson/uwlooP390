# Git and GitHub Self-Learning Exercises for Psychology Students

## Prerequisites
- You have completed the terminal exercises
- You can navigate directories and create/edit files from the command line
...
## Exercise Set 1: GitHub Account and Repository Setup

### Learning Goals
- Create a GitHub account
- Understand what repositories are
- Fork repositories
- Navigate GitHub's interface
...
### 1.2 Understanding Repositories

**Task:** Navigate to the course repository: [https://github.com/brittAnderson/uwlooP390](https://github.com/brittAnderson/uwlooP390)

**Questions to answer:**
1. What do you see in the file list?
2. Can you find the README.md file? What does it contain?
3. Look at the "commits" (click the clock icon with a number). What information does each commit show?

<details>
<summary>Expected observations</summary>

A repository (or "repo") is a project folder tracked by git. It contains:
- Files and directories (just like on your computer)
- A complete history of all changes (commits)
- Information about who made changes and when
- README.md typically explains what the project is about

Commits are snapshots of the project at different points in time. Each shows what changed, when, and who made the change.
</details>

### 1.3 Fork the Course Repository
...
### 1.4 Fork the Practice Repository

**Task:** Repeat the forking process for [https://github.com/brittAnderson/p390Practice](https://github.com/brittAnderson/p390Practice)
...
### 1.5 Explore Repository Features
...
This screenshot confirms you've completed the setup. In a course setting, you might submit this to show you're ready for collaborative work.
...
## Exercise Set 2: Git Installation and Configuration

### Learning Goals
- Install git on your computer
- Configure your identity
- Understand the relationship between git (local) and GitHub (remote)
...
**Question to answer:** After installation, does `git --version` work now?
...
### 2.3 Configure Your Name

**Task:** Type these commands, replacing with YOUR information:
...
### 2.4 Set Your Default Branch Name
...
## Exercise Set 3: Cloning and Basic Git Operations

### Learning Goals
- Clone repositories from GitHub to your computer
- Understand the relationship between local and remote
- Make changes and track them with git

### 3.1 Clone Your Practice Repository
...
5. Copy the HTTPS URL (should be `https://github.com/YOUR-USERNAME/p390Practice.git`)
6. In terminal: `git clone https://github.com/YOUR-USERNAME/p390Practice.git`
7. Type `ls` to verify, then `cd p390Practice`

**Question to answer:** What does cloning do? What's the difference between the repository on GitHub and what's now on your computer?

<details>
<summary>Expected outcome</summary>

Cloning downloads a complete copy of the repository to your computer, including all history.
...
### 3.3 Explore Remote Information
...
### 3.6 Stage Your Changes (git add)
...
## Exercise Set 4: Connecting to the Original Repository (Upstream)

### Learning Goals
- Understand the concept of multiple remotes
- Add the original course repository as "upstream"
- Pull changes from upstream
- Keep your fork synchronized

### 4.1 Check Current Remotes
...
### 4.8 Understanding the Three-Repository Model
...
To contribute to upstream, you create a pull request (coming in Exercise Set 6).
</details>

---

## Exercise Set 5: Working in the gitnames Directory
...
### 5.1 Ensure You Have Latest Changes
...
**Question to answer:** Why do we pull from upstream before starting work?

<details>
<summary>Expected outcome</summary>

This ensures you have the latest changes from the original repo, including any files other students have added.

This prevents conflicts and ensures you're working with the most up-to-date version.

Always start your work session with this pull-merge-push sequence.
</details>

### 5.2 Navigate to gitnames Directory
...
## Exercise Set 6: Creating a Pull Request

### Learning Goals
- Understand what pull requests are
- Create a pull request on GitHub
- Navigate the pull request workflow

### 6.1 Navigate to Your Fork
...
### 6.3 Write Pull Request Description
...
### 6.6 Understanding Pull Request Status

**Task:** Check your pull request status. It will be one of:
- **Open** (pending review)
...
### 6.7 After PR is Merged

**Task:** Once your PR is merged (you'll get a notification), update your local repository:
...
### 6.8 See Everyone's Contributions
...
**Task:** Answer these questions in your own words:

1. What is the purpose of a pull request?
2. Why can't you push directly to the original repository?
3. What's the difference between committing and pushing?
4. When should you pull from upstream?

<details>
<summary>Sample answers</summary>

1. Pull requests let you propose changes to a repository you don't own. The maintainer reviews and decides whether to accept them.

2. The original repository is protected to prevent accidental or malicious changes. Only the owner can directly modify it.

3. Committing saves changes locally (on your computer). Pushing sends those commits to GitHub (your fork).

4. Pull from upstream before starting new work, to ensure you have the latest changes from the original repository.
</details>

---

## Exercise Set 7: Opening an Issue

### Learning Goals
- Understand what issues are used for
- Create an issue on GitHub
- Practice professional technical communication

### 7.1 Understanding Issues

**Task:** Go to `https://github.com/brittAnderson/uwlooP390/issues`
...
### 7.2 Navigate to Practice Repository Issues

**Task:** Go to `https://github.com/brittAnderson/p390Practice/issues`
...
### 7.4 Record Your Issue Number

**Task:** In a text file on your computer, record:
...
### 7.5 Use Issues Constructively

**Task:** Read through some issues on the course repository: `https://github.com/brittAnderson/uwlooP390/issues`
...
### 7.6 Comment on an Issue

**Task:** Find any open issue (yours or someone else's) and add a comment:
...
### 7.7 Understand Issue Labels

**Task:** Look at issues on the main course repo and note any labels (like "bug", "question", "enhancement")
...
### 7.9 Using Issues for Learning

**Task:** Think about situations where you might open a real issue on the uwlooP390 repository.

**Question to answer:** What kinds of problems or questions would be appropriate to report as issues?
...
### 7.10 Reflection on Collaborative Features

**Task:** Think about how pull requests and issues work together.

**Question to answer:** How do pull requests and issues relate? How might you reference an issue in a pull request?
...
## Exercise Set 8: Real-World Workflow Practice
...
1. Learn about branches and branching workflows
2. Explore `.gitignore` files for managing which files git tracks
3. Learn about git tags for marking versions
4. Explore GitHub Actions for automation
5. Practice reviewing pull requests
6. Learn about rebasing (advanced)
...
- Press `q` to quit log/diff viewers
- Close and reopen terminal if stuck
